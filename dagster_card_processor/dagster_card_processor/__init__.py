...
from .downstream_assets import aggregated_results_json, validated_cards_data, load_validated_data_to_duckdb
...
all_assets = [
    ...
    load_validated_data_to_duckdb, # <-- ADD THE NEW ASSET
]
