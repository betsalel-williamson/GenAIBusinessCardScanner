...
const StatusDisplay: React.FC<StatusDisplayProps> = ({ message, type, jsonFilename, onBack }) => {
    let messageClass = '';
    let description = '';
    ...
    switch (type) {
        ...
        case 'no-source':
            ...
            description = "No PDF 'source' field found for the current record, or it's empty. Please ensure your JSON data includes a 'source' field (e.g., 'my_document.pdf').";
            break;
        default:
            messageClass = 'text-gray-600';
            break;
